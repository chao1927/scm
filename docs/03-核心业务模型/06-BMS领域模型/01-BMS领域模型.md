...
> 本文用于 BMS 领域模型设计，承接 [BMS 系统功能设计](35-BMS系统功能设计.md)、[BMS 系统详细设计](45-BMS系统详细设计.md)、[WMS 领域模型](../03-WMS领域模型/01-WMS领域模型.md)、[中央库存领域模型](../04-中央库存领域模型/01-中央库存领域模型.md) 和 [OMS 领域模型](../05-OMS领域模型/01-OMS领域模型.md)。本文覆盖 BMS 从计费对象、计费规则、费用采集、费用计算、调整、对账、账单、发票交接到财务交接的完整结算生命周期。
