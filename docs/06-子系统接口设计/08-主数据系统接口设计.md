...
| 事件消费通道 | RocketMQ；`mdm-business-event-consumer` 订阅上游领域 Topic |
...
```text
RocketMQ Topics: 上游 *-domain-event、mdm-publication-receipt
Consumer Group: mdm-business-event-consumer
```
