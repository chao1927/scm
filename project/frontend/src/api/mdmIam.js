...
export const queryIamMfaConfigurations = (params) => client.get('/iam/v1/mfa/configurations', { params })
export const queryIamMfaChallenges = (params) => client.get('/iam/v1/mfa/challenges', { params })
