...
public interface PutawayMapper {
     ...
     * @since 0.1.0
     */
    record Row(long id, String no, long inspectionId, BigDecimal required, BigDecimal putaway, int status, int version) {
    }
    ...
    @Insert("""
        ...
        """)
    void insert(@Param("id") long id, @Param("no") String no, @Param("inspection") long inspection, @Param("required") BigDecimal required, @Param("putaway") BigDecimal putaway, @Param("status") int status, @Param("version") int version, @Param("operator") long operator);
    ...
    @Update("""
        ...
        """)
    int update(@Param("id") long id, @Param("putaway") BigDecimal putaway, @Param("status") int status, @Param("version") int version, @Param("expected") int expected, @Param("operator") long operator);
}
