...
public class WmsInboundEventController {
    ...
    public ApiResponse<WmsInboundEventApplicationService.ConsumeResult> consume(@Valid @RequestBody EventRequest body, HttpServletRequest request, Authentication authentication) {
        ScmAccessContexts.require(authentication).requireApplication(body.sourceSystem());
        var envelope = new WmsInboundEventApplicationService.EventEnvelope(body.sourceSystem(), body.eventCode(), body.eventType(), body.payload());
