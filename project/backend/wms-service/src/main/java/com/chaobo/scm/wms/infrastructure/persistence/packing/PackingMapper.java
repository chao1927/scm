...
public interface PackingMapper {
    ...
    @Insert("""
        ...
        """)
    void insert(@Param("id") long id, @Param("packingNo") String packingNo, @Param("outboundId") long outboundId, @Param("containerNo") String containerNo, @Param("status") int status, @Param("version") int version);
