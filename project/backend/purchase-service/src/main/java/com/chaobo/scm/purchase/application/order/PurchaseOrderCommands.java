...
public final class PurchaseOrderCommands {
     ...
     * @since 0.1.0
     */
    public record Create(int purchaseType, long supplierId, String supplierCode, String supplierName, long purchaseOrgId, String warehouseCode, String currency, List<Line> lines) {
    }
     ...
     * @since 0.1.0
     */
    public record Line(Long lineId, String skuCode, String skuName, BigDecimal orderQty, BigDecimal unitPrice, BigDecimal taxRate, LocalDate requiredDeliveryDate) {
    }
