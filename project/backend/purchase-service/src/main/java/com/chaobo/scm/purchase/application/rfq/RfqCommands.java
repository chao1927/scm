...
public final class RfqCommands {
     ...
     * @since 0.1.0
     */
    public record Create(int rfqType, long purchaseOrgId, String categoryCode, String sourceRequisitionNo, OffsetDateTime quoteDeadline, List<Line> lines, List<Long> invitedSupplierIds) {
    }
