...
public final class SupplierReturnCommands {
     ...
     * @since 0.1.0
     */
    public record Create(String sourceOrderNo, long supplierId, long purchaseOrgId, String warehouseCode, List<Line> lines) {
    }
