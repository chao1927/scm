...
public final class InboundCommands {
     ...
     * @since 0.1.0
     */
    public record RecordAsn(String orderNo, String asnNo, long supplierId, long purchaseOrgId, String warehouseCode, String skuCode, BigDecimal notifiedQty) {
    }
     ...
     * @since 0.1.0
     */
    public record SyncWms(int version, BigDecimal receivedQty, BigDecimal qualifiedQty, BigDecimal unqualifiedQty, BigDecimal putawayQty, String reason) {
    }
}
