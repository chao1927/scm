...
public interface InboundTrackingReadModelPort {
     ...
     */
    PageResult<InboundTrackingView> page(Long purchaseOrgId, String orderNo, String asnNo, String warehouseCode, Integer status, int pageNo, int pageSize);
