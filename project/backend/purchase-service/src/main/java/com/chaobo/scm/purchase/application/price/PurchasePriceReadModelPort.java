...
public interface PurchasePriceReadModelPort {
     ...
     */
    PageResult<PurchasePriceView> page(Long purchaseOrgId, Long supplierId, String skuCode, String currency, Integer status, int pageNo, int pageSize);
