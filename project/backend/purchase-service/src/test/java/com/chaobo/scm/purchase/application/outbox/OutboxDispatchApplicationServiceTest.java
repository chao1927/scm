...
class OutboxDispatchApplicationServiceTest {
    ...
    /**
     * 执行命令 {@code dispatchMarksPublishedAfterBrokerSuccess}。
     *
    ...
    /**
     * 执行命令 {@code dispatchMarksFailedAfterBrokerFailure}。
     *
     * <p>该方法完成当前用例中的一个明确业务动作；状态修改、权限、幂等和异常语义由所属层次共同约束。
     */
    @Test
    ...
    private OutboxMessage message() {
        return new OutboxMessage(1, "PUR-1", "PurchaseOrderPublished", "PURCHASE_ORDER", "1001", "{}", 0);
    }
