 ...
 * @since 0.1.0
 */
public interface SupplierContractReadModelPort {
     ...
     * @return 处理当前类型职责中的操作的结果，类型为 {@code Optional<SupplierContractView>}
     */
    Optional<SupplierContractView> detail(long id);
     ...
     */
    PageResult<SupplierContractView> page(Long supplierId, Integer status, String keyword, int pageNo, int pageSize);
}
