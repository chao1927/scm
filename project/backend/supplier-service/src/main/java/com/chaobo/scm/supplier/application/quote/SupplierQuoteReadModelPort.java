 ...
 * @since 0.1.0
 */
public interface SupplierQuoteReadModelPort {
     ...
     */
    Optional<SupplierQuoteView> detail(long id);
     ...
     */
    PageResult<SupplierQuoteView> page(Long supplierId, Integer status, String keyword, int page, int size);
}
