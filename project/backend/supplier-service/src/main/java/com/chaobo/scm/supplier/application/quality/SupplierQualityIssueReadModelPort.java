...
/**
 * SupplierQualityIssueReadModelPort。
 *
 ...
 * @since 0.1.0
 */
public interface SupplierQualityIssueReadModelPort {
     ...
     */
    Optional<SupplierQualityIssueView> detail(long id);
     ...
     */
    PageResult<SupplierQualityIssueView> page(Long supplierId, Integer status, Integer severity, int pageNo, int pageSize);
