...
/**
 * SupplierQualificationReadModelPort。
 *
 ...
 * @since 0.1.0
 */
public interface SupplierQualificationReadModelPort {
     ...
     */
    Optional<SupplierQualificationView> detail(long id);
     ...
     */
    PageResult<SupplierQualificationView> page(Long supplierId, Integer status, int pageNo, int pageSize);
}
