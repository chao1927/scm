 ...
 */
@Component
public class SupplierQuoteExpiryTask {
    ...
    /**
     * 创建 SupplierQuoteExpiryTask。
     *
     * <p>构造阶段集中接收必需依赖或恢复对象状态，确保实例创建后即可安全参与所属用例。
     * @param service 应用或外部协作依赖，类型为 {@code SupplierQuoteApplicationService}
     */
    public SupplierQuoteExpiryTask(SupplierQuoteApplicationService service) {
     ...
     */
    @Scheduled(cron = "${scm.quote.expire-cron:0 20 0 * * *}")
    public void expire() {
