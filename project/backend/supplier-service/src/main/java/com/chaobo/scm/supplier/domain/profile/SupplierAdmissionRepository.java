 ...
 * @since 0.1.0
 */
public interface SupplierAdmissionRepository {
     ...
     */
    Optional<SupplierAdmissionAggregate> findById(long id);
     ...
     */
    void save(SupplierAdmissionAggregate aggregate, long operatorId);
}
