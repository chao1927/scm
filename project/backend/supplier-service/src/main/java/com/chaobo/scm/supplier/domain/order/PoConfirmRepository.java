 ...
 * @since 0.1.0
 */
public interface PoConfirmRepository {
     ...
     */
    Optional<PoConfirmAggregate> findById(long id);
     ...
     * @return 查询并返回的结果，类型为 {@code Optional<PoConfirmAggregate>}
     */
    Optional<PoConfirmAggregate> findByPurchaseOrderId(long id);
     ...
     */
    void save(PoConfirmAggregate aggregate, long operator);
}
