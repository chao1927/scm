 ...
 * @since 0.1.0
 */
public interface PoConfirmReadModelPort {
     ...
     */
    Optional<PoConfirmView> detail(long id);
     ...
     */
    PageResult<PoConfirmView> page(Long supplierId, Integer status, String keyword, int pageNo, int pageSize);
}
