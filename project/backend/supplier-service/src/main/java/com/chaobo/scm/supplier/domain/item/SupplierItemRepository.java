...
public interface SupplierItemRepository {
     ...
     */
    Optional<SupplierItemAggregate> findById(long id);
     ...
     */
    List<SupplierItemAggregate> findAvailableBySupplier(long supplierId);
     ...
     * @return 查询并返回的结果，类型为 {@code List<SupplierItemAggregate>}
     */
    List<SupplierItemAggregate> findAvailableBySku(String skuCode);
     ...
     */
    boolean exists(long supplierId, String skuCode);
     ...
     */
    void save(SupplierItemAggregate aggregate, long operatorId);
}
