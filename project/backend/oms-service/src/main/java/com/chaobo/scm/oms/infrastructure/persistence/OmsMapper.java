...
public interface OmsMapper {
     ...
     * @since 0.1.0
     */
    record SalesOrderRow(Long id, String orderNo, String channelCode, String channelOrderNo, Long customerId, String receiverAddress, String linePayload, BigDecimal totalAmount, int status, String reviewRemark, long version) {
    }
